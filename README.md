...
- мышь - поворот камеры
- ПКМ - переключить курсор/управление камерой
- `1/2/3` - выбрать сферу
...
сцену, модель, материал модели, материал сферы, качество и подкрутить
экспозицию, небо, свет, шероховатость и металлическость.
