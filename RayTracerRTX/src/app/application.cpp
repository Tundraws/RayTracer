...
std::optional<std::filesystem::path> openTextureFileDialog(GLFWwindow* window);
...
std::optional<std::filesystem::path> openTextureFileDialog(GLFWwindow* window)
{
    ...
    ofn.lStructSize = sizeof(ofn);
    ofn.hwndOwner = window != nullptr ? glfwGetWin32Window(window) : nullptr;
    ofn.lpstrTitle = L"\u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0446\u0432\u0435\u0442\u043E\u0432\u0443\u044E \u0442\u0435\u043A\u0441\u0442\u0443\u0440\u0443";
    ofn.lpstrFilter =
        L"\u0418\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u044F (*.png;*.jpg;*.jpeg;*.ppm)\0*.png;*.jpg;*.jpeg;*.ppm\0"
        L"PNG (*.png)\0*.png\0"
...
void drawImguiPanel(AppState& appState, const FrameStats& stats, GLFWwindow* window)
{
    ...
    const auto drawMeshMaterialEditor = [&]()
    {
        ...
        if (ImGui::Button(u8c(u8"\u0417\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C \u0446\u0432\u0435\u0442\u043E\u0432\u0443\u044E \u0442\u0435\u043A\u0441\u0442\u0443\u0440\u0443...##mesh_base_color_texture")))
        {
            if (const std::optional<std::filesystem::path> texturePath = openTextureFileDialog(window))
            {
                const SceneState before = scene;
                ...
                if (result.changed)
                {
                    appState.lastUiMessage = "Цветовая текстура загружена: " + texturePath->filename().string();
                    appState.lastUiMessageIsError = false;
                }
                else
                {
                    appState.lastUiMessage = "Не удалось загрузить цветовую текстуру.";
                    appState.lastUiMessageIsError = true;
                }
            }
        }
        ...
        ImGui::TextWrapped("%s", u8c(u8"\u0426\u0432\u0435\u0442\u043E\u0432\u0443\u044E \u0442\u0435\u043A\u0441\u0442\u0443\u0440\u0443 \u043C\u043E\u0436\u043D\u043E \u0437\u0430\u0434\u0430\u0442\u044C \u0437\u0434\u0435\u0441\u044C \u0438\u043B\u0438 \u0447\u0435\u0440\u0435\u0437 OBJ/MTL, glTF/GLB, JSON. Normal/roughness/metallic maps \u043F\u043E\u043A\u0430 \u0442\u043E\u043B\u044C\u043A\u043E \u043E\u0442\u043E\u0431\u0440\u0430\u0436\u0430\u044E\u0442\u0441\u044F."));
